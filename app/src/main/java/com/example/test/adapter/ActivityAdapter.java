...
public class ActivityAdapter extends ArrayAdapter<TaskActivity> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(taskActivity.getParticipateOrNot().equals("未参与")){
            viewHolder.participateOrNot.setTextColor(Color.parseColor("#ffff4444"));
        }else {
            viewHolder.participateOrNot.setTextColor(Color.parseColor("#ff99cc00"));
        }
        ...
        if(taskActivity.getTimeLimit().equals("已超时")){
            viewHolder.timeLimit.setTextColor(Color.parseColor("#ffff4444"));
        }else{
            viewHolder.timeLimit.setTextColor(Color.parseColor("#ff99cc00"));
        }
        return view;
    }
